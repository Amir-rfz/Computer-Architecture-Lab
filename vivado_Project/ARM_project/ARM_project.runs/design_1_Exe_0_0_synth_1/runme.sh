...
HD_PWD='C:/Users/Amin/Documents/Computer_Arch_Lab/ARM/ARM_project/ARM_project.runs/design_1_Exe_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Exe_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Exe_0_0.tcl
